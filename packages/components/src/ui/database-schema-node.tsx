...
import { BaseNode, BaseNodeContent, BaseNodeHeader } from '@zchemacraft/components/ui/base-node';
import { TableBody, TableCell, TableRow } from '@zchemacraft/components/ui/table';
